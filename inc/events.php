...
<div class="event blocks">
	...
	<div class="event-right">
        <div class="event-day"><?php echo $date->format('l'); ?></div>
        <div class="event-month-num"><?php echo $date->format('n.d'); ?></div>
        <div class="event-title"><?php echo ac_get_title(38); ?></div>
    </div><!-- envent right -->
